...
class DeepQLearning:
    ...
    def createNetwork(self):
        ...
        hidden_layer_2 = Dense(56, activation='relu')(hidden_layer_1)
        output_layer = Dense(self.actionDimension, activation='linear')(hidden_layer_2)
    ...
    def selectAction(self,state,index):
        ...
        # otherwise, we are selecting greedy actions
            ...
            # updated form: takes the array state based on the obs space of the game environment 
            Qvalues=self.mainNetwork.predict(np.array([state]))
